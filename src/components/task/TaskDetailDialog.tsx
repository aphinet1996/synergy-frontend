...
export function TaskDetailDialog({
  ...
  const getFileName = (file: any): string => {
    ...
    return file.originalName || file.filename || file.name || 'ไฟล์แนบ';
  };
  ...
  const handleDownloadAllFiles = async () => {
    if (!editedTask.attachments || editedTask.attachments.length === 0) return;
    
    for (const file of editedTask.attachments) {
              ...
              <div className="px-6 py-4 space-y-6">
                ...
                <div className="space-y-2">
                  <div className="flex items-center justify-between">
                    ...
                    {editedTask.attachments && editedTask.attachments.length > 1 && (
                      <Button
                        variant="outline"
                        size="sm"
                  ...
                  {editedTask.attachments && editedTask.attachments.length > 0 ? (
                    <div className="space-y-2">
                      {editedTask.attachments.map((file, idx) => {
                        ...
                        const mimetype = typeof file === 'object' ? file.mimetype : '';
                        ...
                        return (
                          ...
                          >
                            {/* File Icon */}
                            <div className="flex-shrink-0 w-10 h-10 flex items-center justify-center bg-white rounded-lg border">

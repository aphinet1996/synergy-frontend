...
//             if (response.success) {
//                 toast.success('ลบคลินิกสำเร็จ');
//                 navigate('/clinic');
//             } else {
//                 toast.error(response.error || 'ไม่สามารถลบคลินิกได้');
//             }
//         } catch (error) {
//             console.error('Delete clinic error:', error);
//             toast.error('เกิดข้อผิดพลาดในการลบคลินิก');
//         } finally {
//             setIsDeleting(false);
...
//                                         {clinic.clinicLevel === 'easy' ? 'Easy' : clinic.clinicLevel === 'soso' ? 'So so' : 'Hell on earth'}
//                                     </Badge>
//                                 </div>
//                             </div>
//                         </div>
...
//                                 แก้ไข
//                             </Button>
//                             <Button variant="outline" className="border-red-200 text-red-600 hover:bg-red-50" onClick={() => setIsDeleteDialogOpen(true)}>
...
//                 <AlertDialogContent>
//                     <AlertDialogHeader>
//                         <AlertDialogTitle>ยืนยันการลบคลินิก</AlertDialogTitle>
//                         <AlertDialogDescription>
//                             คุณต้องการลบคลินิก <span className="font-semibold text-gray-900">"{clinic?.name.th}"</span> ใช่หรือไม่?
//                             <br />
//                             <span className="text-red-600 mt-2 block">
//                                 การดำเนินการนี้ไม่สามารถย้อนกลับได้ ข้อมูลทั้งหมดของคลินิกจะถูกลบอย่างถาวร
//                             </span>
//                         </AlertDialogDescription>
//                     </AlertDialogHeader>
//                     <AlertDialogFooter>
...
import { BoardTab } from '@/components/clinic/BoardTab';
import { DocumentTab } from '@/components/clinic/DocumentTab';
import { ClinicInfoTab } from '@/components/clinic/ClinicInfo';
import {
    ArrowLeft,
    Edit,
    Trash2,
